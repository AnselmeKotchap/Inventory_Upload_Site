...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      alert("Cannot Send and Empty File");
    } else {
      setUploading(true);
      try {
        ...
        if (response.ok) {
          ...
          setFailed(true);
          setErrorMessage("Code secret invalide");
        } else if (
        ...
        // upload.current.value = null;
        // agent_nameRef.current.value = null;
        // usernameRef.current.value = null;
        // secretCodeRef.current.value = null;
      }
    }
  };
  ...
  return (
    <div className="App">
      <header className="App-header">
        <img src={kbm} alt="KBM" />
        Télécharger le fichier d'inventaire
      </header>
      <div className="Body">
        <form className="form" ref={form} name="submitForm" id="submitForm">
          ...
          <input
            ...
            name="username"
            ref={usernameRef}
            placeholder="Nom d'utilisateur du client KBM"
            required
            onChange={handleChange}
          />
          <input
            ...
            name="token"
            ref={secretCodeRef}
            placeholder="Clé secrète de l'agent"
            required
        ...
        <Modal show={show} onHide={handleClose}>
          <Modal.Header>
            <Modal.Title>Fichier de prévisualisation</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <DataTable
              pagination
